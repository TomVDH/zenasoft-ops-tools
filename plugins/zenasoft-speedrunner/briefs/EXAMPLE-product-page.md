# Brief: Fleet Safety Feature Page
...
Landing page for the Fleet Safety feature. Target audience: safety managers and
fleet operations leads evaluating WorkAware. Goal: get them to book a demo.

## Design reference

Clean and professional. Two-column hero with headline left, product screenshot
right. Features in a three-up card layout. How-it-works as a numbered vertical
sequence. CTA band at the bottom.
...
**Heading:** Ready to see Fleet Safety in action?

**Supporting text:** Book a 20-minute walkthrough with our team.

**Button:** Book a Demo (primary)
...
No form on this page. The "Book a Demo" buttons link to the meetings page.

## Notes

- Keep it short. Safety managers scan, they don't read essays.
- No pricing on this page.
- The page will sit under workaware.com/fleet-safety.
